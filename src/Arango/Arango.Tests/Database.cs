...
namespace Arango.Tests
{
    public static class Database
    {
        ...
        {
            await Database.DeleteTestDatabaseAsync(Database.TestDatabaseGeneral);
            await Database.DeleteTestDatabaseAsync(Database.TestDatabaseOneTime);
        }
